...
namespace DAO
{
    ...
    public class DataProvider
    {
        ...
        private void connect()
        {
            try
            {
                //string strCnn = "Data Source=DESKTOP-ORIGJ48;Initial Catalog=ProductOrder;Integrated Security=True";
        ...
        public bool executeNonQuery(string strSQL)
        {
         ...
         public int GetTeamID(string strSQL)
        {
            try
            {
                int a;
        ...
        public bool checkMain(string strSQL)
        {
            try
            {
                bool a;
