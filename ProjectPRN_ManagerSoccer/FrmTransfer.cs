...
namespace ProjectPRN_ManagerSoccer
{
    ...
    public partial class FrmTransfer : Form
    {
        ...
        private void txtSell_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((new BUSTransfer()).addTransfer(a, Convert.ToDouble(txtPrice.Text))
                    && (new BUSTransfer()).updateAfterSell(a.id,account.TeamID))
                {
        ...
        private void dgListTransfer_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
